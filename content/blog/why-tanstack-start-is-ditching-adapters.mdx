...
description: Why TanStack Start is ditching adapters
image: /images/blog/nitro.jpg
date: "2024-11-22"
authors:
  - morinokami
...
<Callout>
  The text below is from the [TanStack Blog](https://tanstack.com/blog/why-tanstack-start-is-ditching-adapters) post. I copied it
  here to test the markdown styles. **TanStack Start is awesome. You should use it.**
</Callout>
