...
This is an example of a doc site built using Content Collections and MDX.

<Callout>

This site is a work in progress. If you see dummy text on a page, it means I'm still working on it. You can follow updates on X [@morinokami](https://x.com/onDemocracy).
