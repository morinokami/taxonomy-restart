---
title: Documentation
description: Build your documentation site using Content Collections and MDX.
---

Taxonomy includes a documentation site built using [Content Collections](https://www.content-collections.dev) and [MDX](http://mdxjs.com).
